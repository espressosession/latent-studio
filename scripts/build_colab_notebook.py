...
def build_app_notebook() -> dict:
    ...
    cells.append(
        markdown_cell(
            ...
            "presentation; test it before relying on it live."
        )
    )
    ...
    cells.append(code_cell("demo = build_app()\ndemo.launch(share=True, theme=THEME)"))
...
def build_training_notebook() -> dict:
    ...
    cells = [
        markdown_cell(
            ...
            "Produces the project LoRAs (**Hokusai**, **Turner**, **Monet**, **Cézanne**, **Dürer**, "
            "**Hiroshige**, **Rembrandt**) from public-domain "
            "(CC0) Art Institute of Chicago artworks and pushes them to the Hugging Face "
            "Hub, from where the main app (`latent_studio_colab.ipynb`) loads them. This "
            "pipeline is a Colab workflow — deliberately **not** a live feature of the app.\n\n"
